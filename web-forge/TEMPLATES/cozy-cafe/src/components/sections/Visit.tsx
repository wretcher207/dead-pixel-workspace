      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        >
          ...
          <p className="text-sm text-[#6b5f56] font-light leading-relaxed">
            Free street parking. Additional lot parking around back.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-3 text-[#6b5f56] font-light text-sm leading-relaxed mb-6">
            <li>Dine-in &bull; Takeout &bull; Local delivery Fridays</li>
            <li>Dogs welcome on the patio</li>
            <li>Free WiFi &mdash; please don&rsquo;t stay forever</li>
          ...
          <div className="space-y-2">
            <a
              ...
              style={{ fontFamily: "var(--font-sans)" }}
            >
              <span>@thecoppercup</span>
              <span className="text-[#e8dfd4]">&mdash;</span>
