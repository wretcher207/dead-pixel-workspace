  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(61,46,36,0.95) 0%, rgba(139,94,60,0.4) 40%, rgba(61,46,36,0.9) 70%, rgba(122,158,126,0.15) 100%)",
          opacity: 0.5,
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 flex-1 flex items-center px-8 md:px-16 pb-20">
        ...
        >
          ...
          >
            Good mornings{" "}
            <em className="text-[#c9a96e] not-italic italic">start</em>
            <br />
            right here.
          </motion.h1>
